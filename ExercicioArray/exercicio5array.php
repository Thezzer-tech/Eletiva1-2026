                        ...
                        <form class="row" method="post">
                            ...
                            for($i = 0; $i < 5; $i++)
                                echo '<div class="col-md-6 pt-3">
                                    <label class="form-label" for="nomes[]">Informe Titulo: </label>
                                    <input type="text" id="nomes[]" name="nomes[]" class="form-control">
                                </div>
                                <div class="col-md-3 pt-3">
                                    <label class="form-label" for="qntd[]">Informe Quantidade: </label>
                                    <input type="number" id="qntd[]" name="qntd[]" class="form-control">
                                    </div>';
                            ?>
                                ...
                                <?php
                                    if($_SERVER["REQUEST_METHOD"] == "POST"){
                                        ...
                                        foreach($mapa_livros as $nome => $quantia){
                                            ...
                                            if($primeiro && $quantia < 5 ){
                                                echo "<p>livro em baixa quantidade!!</p>";
